...
int SERVO_Initialization(void)
{
    ...
    /* Rate PID init */
    pid_init(&pid_roll,  param.pid.RATE.roll.kp,  param.pid.RATE.roll.ki,  param.pid.RATE.roll.kd,  I_LIMIT_US, AXIS_OUT_LIMIT_US);
    pid_init(&pid_pitch, param.pid.RATE.pitch.kp, param.pid.RATE.pitch.ki, param.pid.RATE.pitch.kd, I_LIMIT_US, AXIS_OUT_LIMIT_US);
    pid_init(&pid_yaw,   param.pid.RATE.yaw.kp,   param.pid.RATE.yaw.ki,   param.pid.RATE.yaw.kd,   I_LIMIT_US, AXIS_OUT_LIMIT_US);
